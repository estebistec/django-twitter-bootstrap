...
urlpatterns = patterns('',
    (r'^$', RedirectView.as_view(url=reverse_lazy('index'))),
    ...
    url(r'^examples/justified-nav\.html$', TemplateView.as_view(template_name='examples/justified-nav.html'), name='justified-nav'),
    ...
    url(r'^examples/sticky-footer-navbar\.html$', TemplateView.as_view(template_name='examples/sticky-footer.html'), name='examples-sticky-footer-navbar'),
